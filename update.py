...
for imdb in tabela ['imdb']:
    ...
    time.sleep(5)
    navegador.find_element_by_xpath('/html/body/div[1]/div[2]/div[2]/div[1]/div[3]/form/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[2]/input[2]').click()
    time.sleep(2)
    navegador.get('http://localhost/wordpress/wp-admin/edit.php?post_type=movies')

    print('FILME: '+imdb+' SUCESSO !!')
